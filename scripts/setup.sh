...
gdown "https://drive.google.com/uc?id=1aucOvtVj22HZA6-aUvejI1OR5wFSpOP4" -O "data/data_urdf.zip"
unzip -q "data/data_urdf.zip" -d "data/" # -q for quiet mode

rm "data/data_urdf.zip"

gdown "https://drive.google.com/uc?id=1P7Vgpsqml3OMH5p8JhsjtxQ7Dl5I7Ax6" -O "data/PointCloud.zip"
